...
$$
\text {   由第一组24，19式   } \left\{ \begin{array}{l} \text {   原式   } = \frac {1}{a} \int \frac {u ^ {2}}{\left[ u ^ {2} + (1 - b) \right] ^ {2}} \mathrm{d} u + \frac {1}{a} \int \frac {1}{\left[ u ^ {2} + (1 - b) \right] ^ {2}} \mathrm{d} u \\ = \frac {b \tan a x}{2 a (1 - b) (1 - b + \tan^ {2} a x)} + \frac {2 - b}{2 a (1 - b) ^ {\frac {3}{2}}} \arctan \frac {\tan a x}{\sqrt {1 - b}} + C \end{array} \right.
$$
...
$$
\begin{array}{l} \begin{array}{r l} & \text {   原式   } = \frac {1}{a} \int \frac {u ^ {2}}{\left[ u ^ {2} - (b - 1) \right] ^ {2}} \mathrm{d} u + \frac {1}{a} \int \frac {1}{\left[ u ^ {2} - (b - 1) \right] ^ {2}} \mathrm{d} u \\ & \text {   由第一组34，32式   } \\ & = \frac {b \tan a x}{2 a (b - 1) (b - 1 - \tan^ {2} a x)} + \frac {2 - b}{4 a (b - 1) ^ {\frac {3}{2}}} \ln \left| \frac {\tan a x + \sqrt {b - 1}}{\tan a x - \sqrt {b - 1}} \right| + C \end{array} \\ = \frac {b \sin 2 a x}{4 a (1 - b) \left(1 - b \cos^ {2} a x\right)} + \frac {2 - b}{2 a (1 - b)} \cdot \frac {1}{2 \sqrt {b - 1}} \ln \left| \frac {\tan a x - \sqrt {b - 1}}{\tan a x + \sqrt {b - 1}} \right| + C. \\ \end{array}
$$
...
27. 解 凑微分 $\mathrm{d}(\arcsin ax)=\frac{a}{\sqrt{1-(ax)^{2}}}\mathrm{d}x$ ，故

原式 $= \frac{1}{a}\int \arcsin ax\mathrm{d}(\arcsin ax) = \frac{1}{2a} (\arcsin ax)^{2} + C.$

28. 解 凑微分 $\mathrm{d}(\arccos ax) = \frac{a}{-\sqrt{1 - (ax)^2}}\mathrm{d}x$ 原式 $= -\frac{1}{a}\int \arccos ax\mathrm{d}(\arccos ax) = -\frac{1}{2a} (\arccos ax)^{2} + C$

29. 解 凑微分 $\mathrm{d}(\arctan ax) = \frac{a}{1 + a^2x^2}\mathrm{d}x$ ，故

原式 $= \frac{1}{a}\int \arctan ax\mathrm{d}(\arctan ax) = \frac{1}{2a} (\arctan ax)^{2} + C$

30. 解 凑微分 $\mathrm{d}(\operatorname{arccot} ax) = -\frac{a}{1 + a^2 x^2} \, dx$ ，故
...
$$
\begin{array}{l} = \frac {x ^ {2}}{2} \arccos \frac {x}{a} + \frac {1}{2} \int x ^ {2} \frac {1}{\sqrt {a ^ {2} - x ^ {2}}} \mathrm{d} x \quad \text {   由第二组16式   } \\ = \frac {x ^ {2}}{2} \arccos \frac {x}{a} - \frac {1}{2} \left(\frac {x}{2} \sqrt {a ^ {2} - x ^ {2}} - \frac {a ^ {2}}{2} \arcsin \frac {x}{a}\right) + C \\ = \frac {x ^ {2}}{2} \arccos \frac {x}{a} - \frac {x}{4} \sqrt {a ^ {2} - x ^ {2}} + \frac {a ^ {2}}{4} \arcsin \frac {x}{a} + C. \\ \end{array}
$$

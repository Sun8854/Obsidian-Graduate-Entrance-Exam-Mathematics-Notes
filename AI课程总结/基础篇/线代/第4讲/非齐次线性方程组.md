...
$$
> [!tip] 
> $$\boxed{\alpha_1,\alpha_2,\ldots,\alpha_{m}\text{ 线性无关}\Rightarrow\alpha_1-\alpha_2,\alpha_1-\alpha_3,\ldots,\alpha_1-\alpha_{m}\text{ 线性无关}}$$
...
所以 $\boldsymbol{\alpha}_5$ 可由 $\boldsymbol{\alpha}_2,\boldsymbol{\alpha}_3,\boldsymbol{\alpha}_4$ 表示；
...
所以 $\boldsymbol{\alpha}_4$ 可由 $\boldsymbol{\alpha}_1,\boldsymbol{\alpha}_2,\boldsymbol{\alpha}_5$ 表示。
